...
using static AmazingAssets.AdvancedDissolve.Editor.ShaderGraph.ExtendedShaderUtils;
...
namespace AmazingAssets.AdvancedDissolve.Editor.ShaderGraph
{
    ...
    /// </summary>
    public abstract class ExtendedBaseShaderGUI : ShaderGUI
    {
        ...
        protected enum Expandable
        {
            ...
            /// <summary>
            /// Use this for Advanced Dissolve foldout.
            /// </summary>
            AdvancedDissolve = 1 << 4,
        }
        ...
        public MaterialHeaderScopeList m_MaterialScopeList = new MaterialHeaderScopeList(uint.MaxValue & ~(uint)Expandable.Advanced);
        ...
        public virtual void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            if (filter.HasFlag(Expandable.AdvancedDissolve))
                m_MaterialScopeList.RegisterHeaderScope(new GUIContent("Advanced Dissolve"), (uint)Expandable.AdvancedDissolve, DrawAdvancedDissolveOptions);
        ...
        /// </summary>
        /// <param name="material">The material to use.</param>
        public virtual void DrawAdvancedDissolveOptions(Material material) { }
        ...
        internal static void UpdateMaterialSurfaceOptions(Material material, bool automaticRenderQueue)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    castShadows = UnityEditor.Rendering.Universal.ShaderGUI.LitGUI.IsOpaque(material);
                }
            }
