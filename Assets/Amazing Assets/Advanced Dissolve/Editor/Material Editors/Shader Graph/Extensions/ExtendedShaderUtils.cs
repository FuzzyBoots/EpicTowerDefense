...
{
    public static class ExtendedShaderUtils
    {
        ...
        {
            var currentShaderId = ShaderID.Unknown;
            if (assetWithURPMetaData != null)
            {
                ...
                foreach (var asset in AssetDatabase.LoadAllAssetsAtPath(path))
                {
                    ...
                    {
                        currentShaderId = (ShaderID)metadataAsset.shaderID;
                        break;
                    }
                }
            }
        ...
        internal static void UpdateMaterial(Material material, MaterialUpdateType updateType, ShaderID shaderID = ShaderID.Unknown)
        {
            ...
            switch (shaderID)
            {
                ...
                case ShaderID.SpeedTree8:
                    ExtendedShaderGraphLitGUI.UpdateMaterial(material, updateType);
                    break;
                case ShaderID.SG_Lit:
                    ExtendedShaderGraphLitGUI.UpdateMaterial(material, updateType);
                    break;
                case ShaderID.SG_Unlit:
                    ExtendedShaderGraphUnlitGUI.UpdateMaterial(material, updateType);
                    break;
