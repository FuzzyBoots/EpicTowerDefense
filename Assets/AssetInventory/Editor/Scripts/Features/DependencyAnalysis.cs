...
namespace AssetInventory
{
    public class DependencyAnalysis
    {
        ...
        private static readonly Regex IncludeFilesRegex = new Regex(@"#include\s*""(.+?)""", RegexOptions.Compiled); // Regex to match include lines and capture file names
        ...
        {
            if (af == null || processedGuids.ContainsKey(af.Guid)) return;
